...
function dailyData(){
  ...
  for (let time = 0; time < 24; time++) {
    ...
    addNewHeatMap(heatmapData,displayText, delay, {"count": time, "maxCount": 23, "type": "timeLapse"});
...
function casualtyData (){
  ...
  addNewHeatMap(heatmapData,"Total Casualties", 0, {"pulsate": true, "count": 0 , "maxCount": 1});
