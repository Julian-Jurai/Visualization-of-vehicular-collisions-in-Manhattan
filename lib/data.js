...
function dailyData(){
  ...
  for (let time = 0; time < 24; time++) {
    ...
    tsvFile[displayText] = heatmapData.length;
    console.log(tsvFile);
    heatmapData = adjustData(heatmapData);
    addNewHeatMap(heatmapData,displayText, delay);
    delay += 1000;
    heatmapData = [];
  }//for
  window.name = "Collisions";
...
// window.i = 0;
// window.recursiveCalls = 0;
// function addNewHeatMap (heatmapData){
//   // let i = 0;
//
//   function synchTimeout() {
//     console.log('new timeout')
//     setTimeout( ()=>{
//     i++;
//     if (i < 8) {
//       window.recursiveCalls+= 1;
//       console.log(recursiveCalls)
//       synchTimeout();
//     } else {
//       console.log("rendered");
//       clearHeatmap ();
//       createHeatmap(adjustData(heatmapData));
//       window.i = 0;
//     }
//   }, 700);
//   }
